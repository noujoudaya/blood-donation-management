...
<head>
  ...
  <title>Index - MedConnect Bootstrap Template</title>
  ...
  <!-- =======================================================
  * Template Name: MedConnect
  * Template URL: https://bootstrapmade.com/MedConnect-bootstrap-hospital-website-template/
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="header-container container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.jsp" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <h1 class="sitename">MedConnect</h1>
      </a>
      ...
      <a class="btn-getstarted" href="login.jsp">Sign in</a>
      ...
      <div class="container-fluid p-0">
        <div class="hero-wrapper">
          <div class="hero-image">
            <img src="assets/img/blood-donation.webp" alt="Blood Donation" class="img-fluid">
          </div>
              ...
              <div class="row">
                <div class="col-lg-7 col-md-10" data-aos="fade-right" data-aos-delay="100">
                  <div class="content-box">
                    <h1 data-aos="fade-up" data-aos-delay="200">Save Lives Through Every Drop</h1>
                    <p data-aos="fade-up" data-aos-delay="250">
                      MedConnect is a smart blood donation platform that connects generous donors with hospitals and individuals in urgent need.
                      Register now to give or request blood safely and efficiently.
                    </p>
                ...
                <div class="row gy-4">
                  ...
                  <div class="col-lg-4">
                    <div class="feature-item" data-aos="fade-up" data-aos-delay="450">
                      ...
                      <div class="feature-text">
                        <h3>Easy Donation</h3>
                        <p>Register in minutes and get matched to local hospitals or patients who need your blood type.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-4">
                    <div class="feature-item" data-aos="fade-up" data-aos-delay="500">
                      ...
                      <div class="feature-text">
                        <h3>Life-Saving Matches</h3>
                        <p>Our system automatically finds compatible donors based on blood type and location.</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-4">
                    <div class="feature-item" data-aos="fade-up" data-aos-delay="550">
                      ...
                      <div class="feature-text">
                        ...
                        <p>Join a network of volunteers dedicated to saving lives and supporting health initiatives.</p>
                      </div>
                    </div>
                  </div>
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="about-content">
              ...
              <div class="cta-wrapper mt-4">
                <a href="about.jsp" class="btn btn-primary">Learn More About Us</a>
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="department-card">
              ...
              <div class="department-content">
                ...
                <a href="department-details.jsp" class="btn-learn-more">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
            <div class="service-card">
              ...
              <div class="service-content">
                ...
                <a href="services.jsp" class="service-btn">
                  Learn More
                  <i class="fas fa-arrow-right"></i>
                </a>
              </div>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <div class="cta-buttons" data-aos="fade-up" data-aos-delay="300">
              <a href="appointment.jsp" class="btn-primary">Book Appointment</a>
              <a href="doctors.jsp" class="btn-secondary">Find a Doctor</a>
            </div>
          </div>
        </div>
      ...
      <div class="row gy-4">
        <div class="col-lg-4 col-md-6 footer-about">
          <a href="index.jsp" class="logo d-flex align-items-center">
            <span class="sitename">MedConnect</span>
          </a>
